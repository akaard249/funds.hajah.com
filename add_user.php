...
<div class="services__appoinment" style="margin-right:15%;margin-left:15%;margin-top:30px;margin-bottom:30px;">
						...
						<form action="api/api.php" method="post">
							<input type="text" name="user_id" placeholder="اسم الدخول" required>
<?php echo$error ?>
							<input type="text" name="user_name" placeholder="اسم العميل" required>
							<input type="text" name="user_company" placeholder="اسم الشركة" required>
							<input type="number" name="user_share" placeholder="كمية البتاع" required>
							<input type="text" name="user_br" placeholder="رقم البنك المرجعي" required>
							
							<button type="submit" name="add_user"class="site-btn">إضافة العميل</button>
						</form>
					</div>
