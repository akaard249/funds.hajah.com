...
$pending_requests = "select loans.loan_id ,users.user_name , user_company , loans.loan_amount , loans.loan_status , loans.loan_request_date from loans inner join users where users.user_id = loans.user_id and loans.loan_status = '2';";
$pending_cmd = mysqli_query($con,$pending_requests);

$accepted_requests = "select loans.loan_id ,users.user_name , user_company , loans.loan_amount , loans.loan_status , loans.loan_request_date from loans inner join users where users.user_id = loans.user_id and loans.loan_status = '1';";
$accepted_cmd = mysqli_query($con,$accepted_requests);

$rejected_requests = "select loans.loan_id ,users.user_name , user_company , loans.loan_amount , loans.loan_status , loans.loan_request_date from loans inner join users where users.user_id = loans.user_id and loans.loan_status = '0';";
...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <div class="content">
    ...
    <div class="container">
	<div class="tab">
  <button class="tablinks active" onclick="openCity(event, 'pending')">  القروض المعلقة</button>
  <button class="tablinks" onclick="openCity(event, 'accepted')">القروض الممنوحة</button>
  <button class="tablinks" onclick="openCity(event, 'rejected')">القروض المرفوضة</button>
</div>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-striped custom-table">
          ...
          <tbody>
                      ...
                      <td><a href='review.php?request_id=$table[loan_id]'>$table[user_company]</a>
                      ...
                      <td>$table[loan_request_date]</td>
					  
                     
					  
                      <td><a href='review.php?request_id=$table[loan_id]' class='more'>معالجة</a></td>
