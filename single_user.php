...
if(isset($_GET["user_id"])){
	...
	{
		$user_table = mysqli_fetch_assoc($user_data);
		
		$user_name = $user_table["user_name"];
		$user_company = $user_table["user_company"];
		$user_share = $user_table["user_share"];
		$user_br = $user_table["user_br"];
	}
	else{
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="about__video set-bg" data-setbg="img/banner.avif">
                        <a href="https://www.youtube.com/watch?v=PXsuI67s2AA" class="play-btn video-popup"></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="about__text">
                        <div class="section-title">
                            <span>Single User Details</span>
                        ...
                        <ul>
                            <li> Company assocaited : 	  <?php echo" ".$user_company;?></li>
                            <li> Share Amount :  	 <?php echo$user_share;?></li>
                            <li> Benifit Reference : 	  <?php echo$user_br;?></li>
                        </ul>
                        <a href="#" class="primary-btn normal-btn">Do Sth</a>
                    </div>
                </div>
            </div>
        </div>
